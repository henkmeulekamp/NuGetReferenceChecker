...
{
    public class EnumerableXmlReader<T> : IDisposable
    {
        ...
        public IEnumerable<T> Stream()
        {
            ...
            return Stream(nodeName);
        }

        public Func<XNode, T> MyDeserializer = node => DeSerializer(node);
        ...
        /// <returns></returns>
        public IEnumerable<T> Stream(string nodeName)
        {
            //move to  content
                ...
                switch (_reader.NodeType)
                {
                    case XmlNodeType.Element:
                        ...
                        if (_reader.Name.Equals(nodeName, StringComparison.InvariantCulture))
                        {
                            ...
                            if (el != null)
                                yield return MyDeserializer(el);
                        }
                        break;
                }
        ...
        public static T DeSerializer(XNode element)
        {            
